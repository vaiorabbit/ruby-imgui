...
module ImGui
  ...
  def self.import_symbols()
    ...
    attach_function :ImplGlfw_CharCallback, :ImGui_ImplGlfw_CharCallback, [:pointer, :uint], :void
    attach_function :ImplGlfw_InitForOpenGL, :ImGui_ImplGlfw_InitForOpenGL, [:pointer, :bool], :bool
    attach_function :ImplGlfw_InitForVulkan, :ImGui_ImplGlfw_InitForVulkan, [:pointer, :bool], :bool
    attach_function :ImplGlfw_KeyCallback, :ImGui_ImplGlfw_KeyCallback, [:pointer, :int, :int, :int, :int], :void
    attach_function :ImplGlfw_MouseButtonCallback, :ImGui_ImplGlfw_MouseButtonCallback, [:pointer, :int, :int, :int], :void
    attach_function :ImplGlfw_NewFrame, :ImGui_ImplGlfw_NewFrame, [], :void
    attach_function :ImplGlfw_ScrollCallback, :ImGui_ImplGlfw_ScrollCallback, [:pointer, :double, :double], :void
    attach_function :ImplGlfw_Shutdown, :ImGui_ImplGlfw_Shutdown, [], :void
    attach_function :ImplOpenGL2_CreateDeviceObjects, :ImGui_ImplOpenGL2_CreateDeviceObjects, [], :bool
    attach_function :ImplOpenGL2_CreateFontsTexture, :ImGui_ImplOpenGL2_CreateFontsTexture, [], :bool
    attach_function :ImplOpenGL2_DestroyDeviceObjects, :ImGui_ImplOpenGL2_DestroyDeviceObjects, [], :void
    attach_function :ImplOpenGL2_DestroyFontsTexture, :ImGui_ImplOpenGL2_DestroyFontsTexture, [], :void
    attach_function :ImplOpenGL2_Init, :ImGui_ImplOpenGL2_Init, [], :bool
    attach_function :ImplOpenGL2_NewFrame, :ImGui_ImplOpenGL2_NewFrame, [], :void
    attach_function :ImplOpenGL2_RenderDrawData, :ImGui_ImplOpenGL2_RenderDrawData, [:pointer], :void
    attach_function :ImplOpenGL2_Shutdown, :ImGui_ImplOpenGL2_Shutdown, [], :void

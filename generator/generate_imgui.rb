...
require 'ffi'
    ...
    ['ImVec2', 'ImVec4', 'ImVector', 'ImDrawVert', 'ImDrawListSplitter', 'ImDrawCmd', 'ImDrawCmdHeader', 'ImDrawList', 'ImFontAtlas', 'ImGuiKeyData', 'ImGuiViewport'].each do |name| # for forward declaration [TODO] resolve definition order with topological sort or something
